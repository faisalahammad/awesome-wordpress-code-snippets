<?php
/**
 * Gravity Forms Minimum/Maximum Character Limit
 * Source: https: //gravitywiz.com/require-minimum-character-limit-gravity-forms/
 */
...
/**
 * Duplicate the following code block and add your form ID and field ID
 */
